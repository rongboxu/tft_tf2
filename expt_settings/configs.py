...
class ExperimentConfig(object):
    ...
    default_experiments = ["volatility", "electricity", "traffic", "favorita", "humob"]
    ...
    def data_csv_path(self):
        csv_map = {
            ...
            "humob": "humob_data.csv",  # 处理好的数据文件名
        }
    ...
    def hyperparam_iterations(self):
        return 240 if self.experiment == "volatility" else 60  # 这里也可以改，目前不懂功能先不动
    ...
    def make_data_formatter(self):
        ...
        data_formatter_class = {
            ...
            "humob": data_formatters.humob.HumobFormatter,
        }
